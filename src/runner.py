...
#     from notification_db_handler import NotificationDBHandler
...
#     notification_handler = NotificationDBHandler(connection=db)
#     tasks = [consumer.consume(transformer=message_to_eventtype, handler=notification_handler)]
